...
public class HomeProjectDependency extends DelegatingProjectDependency {
    ...
    /**
     * Creates a project dependency on the project at path ":home:domain"
     */
    public Home_DomainProjectDependency getDomain() { return new Home_DomainProjectDependency(getFactory(), create(":home:domain")); }

    /**
     * Creates a project dependency on the project at path ":home:location"
     */
    public Home_LocationProjectDependency getLocation() { return new Home_LocationProjectDependency(getFactory(), create(":home:location")); }

    /**
     * Creates a project dependency on the project at path ":home:network"
     */
    public Home_NetworkProjectDependency getNetwork() { return new Home_NetworkProjectDependency(getFactory(), create(":home:network")); }
